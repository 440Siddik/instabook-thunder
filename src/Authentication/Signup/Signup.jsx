...
import signuplogo from "../../img/Mobile signup-amico.png";
...
const Signup = () => {
  ...
  return (
    <div className="lg:flex w-full px-4 py-4 items-center cont-signup">
      <div className="lg:w-1/2">
        <img src={signuplogo} className="w-full" alt="" />
      </div>
      <div className="lg:w-1/2 lg:ml-[170px] my-4">
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-fuchsia-800 card">
